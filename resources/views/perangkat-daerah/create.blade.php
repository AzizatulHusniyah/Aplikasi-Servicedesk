        ...
        ">
            ...
            ">
                <h5 class="card-title" style="
                    ...
                    font-size: 1.5rem;
                ">
                    <i class="fas fa-plus-circle me-2" style="color: #3B62A4;"></i> Tambah Perangkat Daerah
                </h5>
            </div>

            <div class="card-body" style="padding: 2rem;">
                <form method="POST" action="{{ route('perangkat-daerah.store') }}">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="kode" name="kode" 
                                       value="{{ old('kode') }}" required maxlength="10"
                                       style="
                                           border-radius: 8px;
                                           padding: 0.75rem 1rem;
                                           border: 1px solid #ced4da;
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="url" class="form-control" id="link_esukma" name="link_esukma" 
                                       value="{{ old('link_esukma') }}" required
                                       style="
                                           border-radius: 8px;
                                           padding: 0.75rem 1rem;
                                           border: 1px solid #ced4da;
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="administrasi_pemerintahan" name="administrasi_pemerintahan" value="1"
                                        {{ old('administrasi_pemerintahan') ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-start gap-3 mt-5">
                        ...
                        onmouseout="this.style.backgroundColor='#1E3C72'; this.style.borderColor='#1E3C72'; this.style.boxShadow='none'">
                            <i class="fas fa-save me-2"></i> Simpan Perangkat Daerah
                        </button>
