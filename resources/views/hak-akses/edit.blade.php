...
<div class="row justify-content-center" style="margin: 0; padding-top: 20px;">
    ...
    <div class="col-md-8">
        ...
        <div class="card" style="
            ...
            overflow: hidden;
            font-family: 'Arial', sans-serif; /* Menggunakan font default yang bersih */
        ">
            {{-- Card Header --}}
            <div class="card-header" style="
                background-color: #fff; /* Header putih bersih */
            ...
            ">
                <h5 class="card-title" style="
                    ...
                    font-size: 1.5rem;
                ">
                    <i class="fas fa-user-tag me-2" style="color: #3B62A4;"></i> Edit Hak Akses
                </h5>
            </div>

            {{-- Card Body (Formulir) --}}
            <div class="card-body" style="padding: 2rem;">
                <form method="POST" action="{{ route('hak-akses.update', $role->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="name" name="name" 
                               ...
                               ">
                        {{-- Handling Error (opsional, jika ada validation error dari Laravel) --}}
                        @error('name')
                    ...
                    <div class="mb-5">
                        <h6 style="font-weight: 600; color: #1E3C72;">Daftar Permissions</h6>
                        <div style="
                            padding: 1.5rem;
                        ...
                        ">
                            <p class="text-muted m-0" style="font-style: italic;">
                                <i class="fas fa-lock me-1" style="color: #3B62A4;"></i> Area ini adalah tempat untuk mengatur dan menampilkan daftar *permissions* (izin) yang melekat pada role ini.
                            </p>
                            <p class="text-muted m-0 mt-1" style="font-size: 0.85rem;">
                                Logika *checkbox* *permissions* akan diimplementasikan di sini.
                            </p>
                        </div>
                    </div>
