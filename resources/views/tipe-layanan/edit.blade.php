        ...
        ">
            ...
            ">
                <h5 class="card-title" style="
                    ...
                    font-size: 1.5rem;
                ">
                    <i class="fas fa-edit me-2" style="color: #3B62A4;"></i> Edit Tipe Layanan
                </h5>
            </div>

            <div class="card-body" style="padding: 2rem;">
                <form method="POST" action="{{ route('tipe-layanan.update', $tipeLayanan->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" 
                               value="{{ old('nama', $tipeLayanan->nama) }}" required 
                               style="
                                   border-radius: 8px;
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3"
                                  ...
                                  "
                                  onfocus="this.style.borderColor='#1E3C72'; this.style.boxShadow='0 0 0 0.2rem rgba(30, 60, 114, 0.1)'"
                                  onblur="this.style.borderColor='#ced4da'; this.style.boxShadow='none'">{{ old('keterangan', $tipeLayanan->keterangan) }}</textarea>
                        @error('keterangan')
                            <div class="text-danger mt-1" style="font-size: 0.875rem;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="status_aktivasi" name="status_aktivasi" required
                                ...
                                onfocus="this.style.borderColor='#1E3C72'; this.style.boxShadow='0 0 0 0.2rem rgba(30, 60, 114, 0.1)'"
                                onblur="this.style.borderColor='#ced4da'; this.style.boxShadow='none'">
                            <option value="1" {{ $tipeLayanan->status_aktivasi ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ !$tipeLayanan->status_aktivasi ? 'selected' : '' }}>Non-Aktif</option>
                        </select>
                    ...
                    <div class="d-flex justify-content-start gap-3 mt-5">
                        ...
                        onmouseout="this.style.backgroundColor='#1E3C72'; this.style.borderColor='#1E3C72'; this.style.boxShadow='none'">
                            <i class="fas fa-check-circle me-2"></i> Update Tipe Layanan
                        </button>

                        <a href="{{ route('tipe-layanan.index') }}" class="btn btn-secondary" style="
