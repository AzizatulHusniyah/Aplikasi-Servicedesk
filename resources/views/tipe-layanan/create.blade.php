        ...
        ">
            ...
            ">
                <h5 class="card-title" style="
                    ...
                    font-size: 1.5rem;
                ">
                    <i class="fas fa-plus-circle me-2" style="color: #3B62A4;"></i> Tambah Tipe Layanan
                </h5>
            </div>

            <div class="card-body" style="padding: 2rem;">
                <form method="POST" action="{{ route('tipe-layanan.store') }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3"
                                  ...
                                  "
                                  onfocus="this.style.borderColor='#1E3C72'; this.style.boxShadow='0 0 0 0.2rem rgba(30, 60, 114, 0.1)'"
                                  onblur="this.style.borderColor='#ced4da'; this.style.boxShadow='none'">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="text-danger mt-1" style="font-size: 0.875rem;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-start gap-3 mt-5">
                        ...
                        onmouseout="this.style.backgroundColor='#1E3C72'; this.style.borderColor='#1E3C72'; this.style.boxShadow='none'">
                            <i class="fas fa-save me-2"></i> Simpan Tipe Layanan
                        </button>
