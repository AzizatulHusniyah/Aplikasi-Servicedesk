        ...
        ">
            ...
            ">
                <h5 class="card-title" style="
                    ...
                    font-size: 1.5rem;
                ">
                    <i class="fas fa-plus-circle me-2" style="color: #3B62A4;"></i> Tambah Layanan
                </h5>
            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="kategori_layanan_id" name="kategori_layanan_id" required
                                    ...
                                    @foreach($kategoriLayanan as $kl)
                                        <option value="{{ $kl->id }}" {{ old('kategori_layanan_id') == $kl->id ? 'selected' : '' }}>
                                            {{ $kl->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="tipe_layanan_id" name="tipe_layanan_id" required
                                    ...
                                    @foreach($tipeLayanan as $tl)
                                        <option value="{{ $tl->id }}" {{ old('tipe_layanan_id') == $tl->id ? 'selected' : '' }}>
                                            {{ $tl->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="perangkat_daerah_id" name="perangkat_daerah_id" required
                                    ...
                                    @foreach($perangkatDaerah as $pd)
                                        <option value="{{ $pd->id }}" {{ old('perangkat_daerah_id') == $pd->id ? 'selected' : '' }}>
                                            {{ $pd->nama }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control" id="sla_hari" name="sla_hari" 
                                    value="{{ old('sla_hari') }}" min="1" required 
                                    style="
                                        border-radius: 8px;
                                        padding: 0.75rem 1rem;
                                        border: 1px solid #ced4da;
