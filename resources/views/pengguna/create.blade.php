        ...
        ">
            ...
            ">
                <h5 class="card-title" style="
                    ...
                    font-size: 1.5rem;
                ">
                    <i class="fas fa-user-plus me-2" style="color: #3B62A4;"></i> Tambah Pengguna Baru
                </h5>
            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="roles" name="roles[]" multiple required 
                            ...
                            @foreach($roles as $role)
                                <option value="{{ $role->name }}" {{ in_array($role->name, old('roles', [])) ? 'selected' : '' }} style="padding: 8px 12px;">
                                    {{ $role->name }}
                                </option>
                            @endforeach
                        </select>
