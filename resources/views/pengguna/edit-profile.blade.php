        ...
        ">
            ...
            ">
                <h5 class="card-title" style="
                    ...
                    font-size: 1.5rem;
                ">
                    <i class="fas fa-user-cog me-2" style="color: #3B62A4;"></i> Edit Profil Pengguna: {{ $user->name }}
                </h5>
            </div>
            ...
            <div class="card-body" style="padding: 2rem;">
                ...
                <form method="POST" action="{{ route('pengguna.update-profile', $user->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                ">
                                    Perangkat Daerah
                                    <span class="badge bg-info ms-2" style="font-size: 0.7rem;">Dapat Diubah</span>
                                </label>
                                ...
                                <small class="form-text text-muted" style="
                                    ...
                                    display: block;
                                ">
                                    <i class="fas fa-info-circle me-1"></i> Administrator dapat mengubah perangkat daerah kapan saja.
                                </small>
                    ...
                    <div class="d-flex justify-content-start gap-3 mt-4">
                        ...
                        onmouseout="this.style.backgroundColor='#1E3C72'; this.style.borderColor='#1E3C72'; this.style.boxShadow='none'">
                            <i class="fas fa-check-circle me-2"></i> Update Profil
                        </button>

                        <a href="{{ route('pengguna.index') }}" class="btn btn-secondary" style="
